...
<body>
  ...
  <div class="sign-up-container">
    <div class="sign-up">
      ...
      <input type="text" class="name" name="first_name" id="name" placeholder="First Name" required>
      <div id="error1"></div>
      <input type="text" class="last-name" name="last_name" id="lastname" placeholder="Last Name" required>
      <div id="error2"></div>
     
        <input type="text" class="username" name="username" id="username" placeholder="Create a username" required>
        <div id="error3"></div>
        <input type="text" class="email" name="email" id="email" placeholder="Email address" required>
        <div id="error4"></div>
